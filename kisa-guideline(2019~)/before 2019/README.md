...
#### 무차별 대입 공격과는 다르게 패스워드 크랙(crack) 보호법인 계정 잠금을 피할 수 있는 방법이다. 왜냐하면 특정 사용자에 대해 가능한 모든 비밀번호를 대입하는 것이 아니라 성공 가능성이 높은 비밀번호 조합을 계산해 다양한 아이디(이 아디이는 사회 공학 또는 기타 피싱 방법으로 획득)에 해당 비밀번호를 대입해보는 것이기 때문이다.
