...
###### _information_schema.tables_ in MySQL is a default table and (column of information_schema.tables)_table_type="BASE TABLE"_ means it is not a default table, but created by users.
